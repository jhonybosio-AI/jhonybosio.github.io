  ...
  return (
    <main className="min-h-screen bg-blue3-deep text-white font-inter selection:bg-blue3-sky/30 overflow-x-hidden">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-[-10%] right-[-10%] w-[500px] h-[500px] bg-blue3-sky/10 blur-[120px] rounded-full" />
        <div className="absolute bottom-[-10%] left-[-10%] w-[500px] h-[500px] bg-blue3-sky/5 blur-[120px] rounded-full" />
      </div>

      {/* Header/Nav */}
      <nav className="relative z-10 w-full max-w-4xl mx-auto p-6 flex justify-between items-center animate-premium-fade">
        <Link href="/" className="text-gray-400 hover:text-blue3-sky transition-all flex items-center gap-2 group">
      ...
      <section className="relative z-10 max-w-4xl mx-auto px-6 pt-12 pb-20 text-center">
        <div className="inline-block px-4 py-1.5 rounded-full bg-blue3-sky/10 text-blue3-sky text-sm font-semibold mb-6 border border-blue3-sky/20 animate-premium-fade" style={{ animationDelay: '0.1s' }}>
        ...
        <a 
          ...
          className="inline-block bg-blue3-sky hover:bg-blue3-sky/90 text-white font-bold py-4 px-10 rounded-xl text-lg animate-premium-fade animate-magnetic-hover shadow-[0_0_40px_-10px_rgba(0,141,255,0.3)]"
      ...
      <section id="checkout" className="relative z-10 max-w-4xl mx-auto px-6 py-24 text-center">
        <div className="max-w-lg mx-auto p-[1px] rounded-3xl bg-gradient-to-b from-blue3-sky/20 to-transparent animate-premium-fade" style={{ animationDelay: '0.5s' }}>
          <div className="bg-blue3-deep/80 backdrop-blur-xl p-8 md:p-12 rounded-[22px] border border-white/10">
            ...
            <ul className="text-left space-y-4 mb-10 max-w-sm mx-auto">
              <li className="flex items-center gap-3"><TrendingUp className="w-5 h-5 text-blue3-sky flex-shrink-0" /> <span className="text-gray-300 italic">Diagnóstico educacional ao vivo</span></li>
              <li className="flex items-center gap-3"><ShieldCheck className="w-5 h-5 text-blue3-sky flex-shrink-0" /> <span className="text-gray-300 italic">Análise de alocação de ativos</span></li>
              <li className="flex items-center gap-3"><CheckCircle2 className="w-5 h-5 text-blue3-sky flex-shrink-0" /> <span className="text-gray-300 italic">Identificação de conflitos de interesse</span></li>
            </ul>

            <a href="https://buy.stripe.com/cNi5kF5Mqeg1cT71f04ko05" className="block w-full bg-white text-blue3-deep hover:bg-gray-100 font-bold py-4 px-8 rounded-xl text-lg transition-colors animate-magnetic-hover">
               Garantir Minha Vaga
            </a>
