  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto px-6 py-12 space-y-24 relative z-20">
        <section className="liquid-glass p-8 md:p-12">
          ...
          <div className="grid md:grid-cols-2 gap-8 text-gray-400 leading-relaxed font-light">
            <p>A estratégia baseia-se na gestão passiva, fundamentada na eficiência dos mercados.</p>
            <p>O uso de ETFs de baixo custo é a ferramenta mais poderosa.</p>
          </div>
        </section>
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="border-b border-white/10 bg-white/5">
                  ...
                  <th className="p-6 text-xs font-bold uppercase tracking-widest text-white">Conservadora</th>
                  <th className="p-6 text-xs font-bold uppercase tracking-widest text-white">Moderada</th>
                  <th className="p-6 text-xs font-bold uppercase tracking-widest text-white">Sofisticada</th>
                </tr>
              </thead>
              <tbody>
                {allocationData.map((row, i) => (
                  <tr key={i} className="border-b border-white/5 hover:bg-white/5 transition-colors">
                    <td className="p-6 text-white font-bold">{row.category} {row.sub}</td>
